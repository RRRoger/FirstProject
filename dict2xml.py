...
# a = {'a':{'s':1,'b':{'a':[1,2]},'@ser':'xx'}}
# print unparse(a, full_document=True)
# b = """<?xml version="1.0" encoding="UTF-8"?>
# <responseFail code="1" xx="222">
#     <reasoncode>0101</reasoncode>
#     <remark>请求数据缺少必选项</remark>
# </responseFail>"""
# print type(parse(b))
# x = json.dumps(parse(b,process_namespaces=True))
# print x
# print json.loads(x)

# def get_final_post_body():
#     #=======================================================================
#     # 获得最终请求的post_body(XML)
#     #=======================================================================
#     final_post_body = {}
#     Request = {}
#     Request["@service"] = "SSSS"#self.getapiname()
#     Request["@lang"] = 'zn-CH'
#     Request['Head'] = {}
#     Request['Head']['AccessCode'] = "123123"
#     Request['Head']['Checkword'] = "312123"
#     Request['Body'] = {'name':'chenpeng'}
